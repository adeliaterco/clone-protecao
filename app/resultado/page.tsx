          ...
          <div className="max-w-4xl mx-auto w-full">
            ...
            >
              ...
              <p className="text-gray-300 mb-6 text-lg font-semibold break-words">
                Você acabou de descobrir que <strong className="text-orange-400">SEU FILHO</strong> está exposto a predadores online <strong className="text-orange-400">NESTE EXATO MOMENTO.</strong> Cada minuto que passa é um risco real à segurança dele.
              </p>
